...
HD_PWD='D:/mnist_vivado/mnist_vivado.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mnist_design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mnist_design_wrapper.tcl

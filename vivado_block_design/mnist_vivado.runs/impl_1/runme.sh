...
HD_PWD='D:/mnist_vivado/mnist_vivado.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mnist_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mnist_design_wrapper.tcl -notrace

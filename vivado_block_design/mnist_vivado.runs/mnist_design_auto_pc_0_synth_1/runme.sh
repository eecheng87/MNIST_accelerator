...
HD_PWD='D:/mnist_vivado/mnist_vivado.runs/mnist_design_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mnist_design_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mnist_design_auto_pc_0.tcl
